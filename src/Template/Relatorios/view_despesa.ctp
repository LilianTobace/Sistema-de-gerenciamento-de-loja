...
<head>
    ...
    <li><?= $this->Html->link(__('Relatórios de Produto'), ['action' => 'view_produto']); ?></li>
...
<body class="relatorio-venda">
    <h2 class="page-header">Relatório de Despesa</h2>
    <?= $this->Form->create($despesas) ?>
        ...
        <table class="table table-striped" cellpadding="0" cellspacing="0">   
            <thead>
                <tr>
                    ...
                    <th class="th-venda"><?= $this->Paginator->sort('Tipo'); ?></th>
                    <th class="th-venda"><?= $this->Paginator->sort('Valor'); ?></th>
                    <th class="th-venda"><?= $this->Paginator->sort('Criado'); ?></th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                if(isset($_SESSION['listaFiltrada'])){
                    ...
                    for ($i=0; $i<count($listaFiltrada); $i++) { ?>
                        <tr>
                            ...
                            ?>
                            <td><?php echo $tipo; ?></td>
                            <td><?php echo "R$"; echo $listaFiltrada[$i]['valor']; ?></td>
                            <td><?php echo date('d/m/Y H:i:s', strtotime($listaFiltrada[$i]['created']));?></td>
                        </tr>
                ...
                ?>
                    <tr>
                        ...
                        ?>
                        <td><?php echo ($tipo); ?></td>
                        <td><?php echo "R$"; echo ($despesa->valor); ?></td>
    ...
    <!-- Resultado da filtragem -->
     <table id="resultadoFiltro" class="table resultado_relatorio">
        <tr>
            ...
            <th class="resultado_relatorio1 trRodape">Total de Despesas: <?php echo $_SESSION['countTipo'] ?></th>
            <th class="resultado_relatorio1 trRodape">Gasto Total: R$<?php echo $_SESSION['sumValor'] ?></th>
        </tr>
    </table>
</body>
