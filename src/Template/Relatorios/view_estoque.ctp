...
<body class="relatorio-venda">
    <h2 class="page-header">Relatório de Estoque</h2>
    <?= $this->Form->create($produtos) ?>
    <form method="post" action="/projeto/relatorios/view-estoque">
        <label for="estoque_min" style="" class="filtroLabel1">Estoque mínimo: </label>
        <input type="number" name="estoque_min" maxlength="255" min="0" id="estoque_min" class="form-control input1" style="width: 8%;">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label for="estoque_max" class="filtroLabel2">Estoque máximo: </label>
        <input  type="number" name="estoque_max" maxlength="255" min="0" id="estoque_max" class="form-control input2" style="width: 8%">              
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <button type="submit" class="btn btn-default btn-success button1" id="filtro">Filtrar</button>
      
        <a href="../relatorios/graficoEstoque/">
            <img src="/projeto/img/grafico.png" title="Grafico" id="grafico" class="printer imagem1">
        </a>  
        <a href="../relatorios/pdfEstoque/">
        ...
        <table class="table table-striped" cellpadding="0" cellspacing="0">   
            <thead>
                <tr>
                    ...
                    <th class="th-venda"><?= $this->Paginator->sort('Categoria'); ?></th>
                    <th class="th-venda"><?= $this->Paginator->sort('Cor'); ?></th>
                    <th class="th-venda"><?= $this->Paginator->sort('Estoque'); ?></th>
                    <th class="th-venda"><?= $this->Paginator->sort('Preço'); ?></th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                if(isset($_SESSION['listaFiltrada'])){ 
                    ...
                    <tr>
                        ...
                        <td><?php echo $listaFiltrada[$i]['cor'] ?></td>
                        <td class="totalEstoque"><?php echo $listaFiltrada[$i]['estoque'] ?></td>
                        <?php $totalEstoque += $listaFiltrada[$i]['estoque'];
                        $_SESSION['totalEstoque'] = $totalEstoque; ?>
                        <td>R$<?php echo $listaFiltrada[$i]['preco'] ?></td>
                    </tr>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo $categoria ?></td> 
                        <td><?= h($produto->cor) ?></td>
                        <td class="totalEstoque"><?= $this->Number->format($produto->estoque) ?></td>
    ...
    <table id="resultadoFiltro" class="table resultado_relatorio">
        <tr>
            <th class="resultado_relatorio1">
                Estoque de <?php echo $_SESSION['estoque_min'];?> a <?php echo $_SESSION['estoque_max'];?>
            </th>
            <th class="resultado_relatorio1">
                Total de Produtos: <?php echo count($_SESSION['listaFiltrada']);?>
            </th>
            <th class="resultado_relatorio1">
                Total do Estoque:  <span class="TotalEstoque"></span>
            </th>
        </tr>
    </table> 
</body>
...
var TotalEstoque = 0;
    ...
    $(".totalEstoque").each(function(){
        ValotTotal += parseFloat($(this).text());
        TotalEstoque = $(".TotalEstoque").text((ValotTotal).toFixed(0));
    });
</script>