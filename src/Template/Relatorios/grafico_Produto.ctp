...
<body class="relatorio-venda">
    ...
    if(isset($_SESSION['listaFiltrada'])){ ?>
       <p class="p1">Quantidade Total:  <?php echo $_SESSION['quantidadeProduto'] ?></p>
       <p class="p2">Valor Total:  R$<?php echo $_SESSION['valorTotalProduto'] ?></p>
            <div class="div1">
            ...
            var myChart = new Chart(ctx, {
                ...
                options:{
                    ...
                    datasets: [{
                        ...
                        for ($i=0; $i<count($listaFiltrada); $i++) {
                            echo $listaFiltrada[$i]['quantidade']; ?>,
                        <?php 
                        }
                        ?>],
                        backgroundColor: [
