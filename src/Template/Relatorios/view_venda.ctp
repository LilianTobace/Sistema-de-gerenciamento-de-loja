...
<body class="relatorio-venda">
    <h2 class="page-header">Relatório de Venda</h2>
        ...
        <table class="table table-striped" cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th class="th-venda"><?= $this->Paginator->sort('Quantidade de Pagamentos'); ?></th>
            ...
            <tbody>
                <?php if(isset($_SESSION['listaFiltrada'])){ 
                    ...
                    <tr>
                        ...
                        <?php $created =  date("d/m/Y H:m:s", strtotime($listaFiltrada[$i]['created']));?>
    ...
    <table id="resultadoFiltro" class="table resultado_relatorio">
        <tr>
            ...
            <th class="resultado_relatorio1">
                Quantidade de produto: <span class="totalProduto"></span>
            </th>
            <th class="resultado_relatorio1">
                Valor Total:  R$<span class="TotalVenda"></span>
            </th>
        </tr>
    </table> 
</body>
...
<script>
    ...
    var TotalVenda = 0;
        ...
        $(".quant").each(function(){
            ...
            totalProduto = $(".totalProduto").text((totalP).toFixed(0));
        });    

        $(".totalVenda").each(function(){
            ValotTotal += parseFloat($(this).text());
            TotalVenda = $(".TotalVenda").text((ValotTotal).toFixed(2));
        });
