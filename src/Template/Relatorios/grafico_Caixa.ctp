...
<body class="relatorio-venda">
    <h2 class="page-header">Gráfico de Caixa</h2>
    <br />
    <?php if(isset($_SESSION['listaFiltrada'])){ ?>
       <p class="p3">Caixa Com Mais Vendas: <?php echo $_SESSION['idCaixa'] ?></p>
       <p class="p2">Total de Vendas: <?php echo $_SESSION['valorProduto'] ?></p>
       <p class="p2">Valor Total:  R$<?php echo $_SESSION['maisVendas']?></p>
            <div class="div1">
                ...
                options:{
                    ...
                    for ($i=0; $i<count($listaFiltrada); $i++) {
                        if ($listaFiltrada[$i]['estado_caixa'] != 1){
                            $criado = $listaFiltrada[$i]['created'];
                            $hora = $listaFiltrada[$i]['hora_abertura'];?>",
                    "<?php 
                            echo $criado; echo '  '; echo $hora;
                        }
                    }
                    ?>"],
                    datasets: [{
                        label: 'Quantidade de Vendas',
                        data: [0, <?php $valorTotalProduto = $_SESSION['valorTotalP'];
                        for ($i=0; $i<count($valorTotalProduto); $i++) {
                            echo $valorTotalProduto[$i]; ?>,
                        <?php 
                        }
                        ?>],
                        backgroundColor: [
                    ...
                    },
                    {
                        ...
                        data: [0, <?php $valorTotalVenda = $_SESSION['valorTotalVenda'];
                        for ($i=0; $i<count($valorTotalVenda); $i++) {
                            echo $valorTotalVenda[$i]; ?>,
                        <?php 
                        }
                        ?>],
                        hidden: true,
