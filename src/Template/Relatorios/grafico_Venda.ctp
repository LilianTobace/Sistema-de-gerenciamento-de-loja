...
<body class="relatorio-venda">
    ...
    <br />
       ...
       ?>
       <p class="p1">Quantidade total: <?php echo $quantidadeProduto ?></p>
       <p class="p2">Valor Total: R$ <?php echo $valorTotal ?></p>
            <div class="div1">
            ...
            var myChart = new Chart(ctx, {
                ...
                options:{
                    ...
                    for ($i=0; $i<count($listaFiltrada); $i++) {
                        $criado =  date("d/m/Y H:m:s", strtotime($listaFiltrada[$i]['created']));?>",
                    "<?php 
                    echo $criado; 
                    }
                    ?>"],
