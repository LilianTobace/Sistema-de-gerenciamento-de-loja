...
<body class="relatorio-venda">
    <h2 class="page-header">Relatório de Promoção</h2>
    ...
    <form method="post" action="/projeto/relatorios/view-produto">
        ...
        <input type="date" name="data_inicio" maxlength="255" id="data_inicio" class="form-control input1 datepicker">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <label for="data_final" class="filtroLabel2">Data Final: </label>
        <input  type="date" name="data_final" maxlength="255" id="data_final" class="form-control input2 datepicker">              
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <table class="table table-striped" cellpadding="0" cellspacing="0">   
            <thead>
                <tr>
                    ...
                    <th class="th-venda"><?= $this->Paginator->sort('Categoria do Produto'); ?></th>
                    <th class="th-venda"><?= $this->Paginator->sort('Valor'); ?></th>
                    <th class="th-venda"><?= $this->Paginator->sort('Status'); ?></th>
                    <th class="th-venda"><?= $this->Paginator->sort('Data Inicial'); ?></th>
                    <th class="th-venda"><?= $this->Paginator->sort('Data Final'); ?></th>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                if(isset($_SESSION['listaFiltrada'])){
                    ...
                    for ($i=0; $i<count($listaFiltrada); $i++) { ?>
                        <tr>
                            ...
                            <td><?php echo $listaFiltrada[$i]['categorias_produto_id'] ?></td>
                            <td><?php echo $listaFiltrada[$i]['promocao'] ?></td>
                            <td><?php echo $listaFiltrada[$i]['status'] ?></td>
                            <td><?php echo $listaFiltrada[$i]['data_inicio'] ?></td>
                            <td><?php echo $listaFiltrada[$i]['data_final'] ?></td>
                        </tr>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $promoco->data_inicio ?></td>
                        <td><?= h($promoco->data_final)?></td>
                    </tr>
                <?php 
                endforeach;
                }   ?>
