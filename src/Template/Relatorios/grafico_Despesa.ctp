...
<body class="relatorio-venda">
    <h2 class="page-header">Gráfico de Despesa</h2>
    <br />
        <?php 
        if(isset($_SESSION['listaFiltrada'])){
        ?>
            <p class="p1">Total de Despesa: <?php echo $_SESSION['countTipo'] ?></p>
            <p class="p2">Gasto Total: R$ <?php echo $_SESSION['sumValor'] ?></p>
            <div class="div1">
            ...
            var myChart = new Chart(ctx, {
                ...
                options:{
                    ...
                    "<?php 
                    echo $criado =  date("d/m/Y H:m:s", strtotime($criado)); 
                    }
                    ?>"],
                    datasets: [{
