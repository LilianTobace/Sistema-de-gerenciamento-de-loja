...
<body style="text-align: center;">
    ...
    <ul class="nav nav-sidebar">
        <li><?= $this->Html->link(__('Editar Cadastro'), ['action' => 'edit', $user->id]) ?> </li>
            <!-- <?= $this->Form->postLink(__('Deletar Cadastro'), ['action' => 'delete', $user->id], ['confirm' => __('Você tem certeza que deseja deletar o cadastro do(a) funcionário(a) {0}?', $user->name)]) ?> </li> -->
