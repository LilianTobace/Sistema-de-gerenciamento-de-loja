...
echo $this->Html->script('mascara_validacao.js');
...
<link rel="stylesheet" type="text/css" href=/projeto/webroot/css/formularios.css>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.0/jquery.min.js"></script>

<li class="li-head"><?= $this->Html->link(__('Listar Funcionários'), ['action' => 'index']); ?></li>
<?php $this->end(); ?>
<?php $this->assign('tb_sidebar', '<ul class="nav nav-sidebar">' . $this->fetch('tb_actions') . '</ul>'); ?>

<body class="panel panel-default body-form">
    <h1 class="page-header body-h1">Novo Cadastro de Funcionário</h1>
    <div class="body-div">
        ...
        <div class="botao-form">
            <button type="submit" class="btn btn-default botao-form2">Cadastrar</button>
            <?= $this->Form->end() ?>
        </div>
    </div>
</body>    
