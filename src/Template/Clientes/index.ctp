            ...
            <?php foreach ($clientes as $i => $cliente): 
                if($i != 0) { ?>
                    <tr>
                        ...
                        <td class="actions">
                            <?= $this->Html->link('', ['action' => 'view', $cliente->id], ['title' => __('Vizualizar'), 'class' => 'btn btn-default glyphicon glyphicon-eye-open']) ?>
                            <?= $this->Html->link('', ['action' => 'edit', $cliente->id], ['title' => __('Editar'), 'class' => 'btn btn-default glyphicon glyphicon-pencil']) ?>
                            <!-- Button to Open the Modal -->
                            <button type="button" class="btn btn-default glyphicon glyphicon-trash" data-toggle="modal" data-target="#myModal<?=$cliente->id?>"></button>
                            <!-- The Modal -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <h3 class="modal-title">Você tem certeza que deseja deletar o(a) cliente <?=$cliente->name?>?</h3>
                                            <br />
                                            <br />
                                            <?= $this->Form->postLink('Sim', ['action' => 'delete', $cliente->id], ['title' => __('Deletar'), 'class' => 'btn btn-success'])?>
