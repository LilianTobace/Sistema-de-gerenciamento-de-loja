...
<body style="text-align: center;">
    ...
    <div class="panel panel-default" style=" margin-left: 16.7%;">
        <div class="panel-heading">
            <h3 class="panel-title" style="text-align: center; text-indent: -10%; font-size: 200%;"><?= h($cliente->name) ?></h3>
        </div>
        ...
        <table class="table table-striped" style="text-align: center;">
            ...
            <tr>
                ...
                <td><?= date("d/m/Y", strtotime($cliente->data_nasc_cliente)); ?></td>
            </tr>            
            <tr>
                <td><?= __('E-mail') ?></td>
            ...
            <tr>
                <td><?= __('Celular') ?></td>
                <td><?= h($cliente->telefone2_cliente) ?></td>
            </tr>
            <tr>
                <td><?= __('Endereço') ?></td>
                <td><?= h($cliente->endereco_cliente) ?></td>
            </tr>
            <tr>
                <td><?= __('Nº') ?></td>
                <td><?= h($cliente->numero_cliente) ?></td>
            </tr>
            <tr>
                <td><?= __('Bairro') ?></td>
                <td><?= h($cliente->bairro_cliente) ?></td>
            </tr>
            <tr>
                <td><?= __('Cidade') ?></td>
            ...
            <tr>
                <td><?= __('Estado Cliente') ?></td>
                <td><?= h($cliente->estado_cliente) ?></td>
            </tr>
            <tr>
                <td><?= __('Comentário') ?></td>
                <td><?= h($cliente->comentario_cliente) ?></td>
            </tr>

            <tr>
                <td><?= __('CEP') ?></td>
                <td><?= $this->Number->format($cliente->cep_cliente) ?></td>
            </tr>
            <tr>
                <td><?= __('Criado') ?></td>
            ...
            <tr>
                <td><?= __('Modificado') ?></td>
                <td><?php  echo(date("d/m/Y H:m:s", strtotime($cliente->modified))); ?></td>
            </tr>
        </table>
    </div>
</body>
...
<div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="div-modal modal-dialog modal-lg">
        ...
        <!-- Modal Header -->
            ...
            <div id="2" style="text-align: center;"><br />Ao estar no módulo de clientes, procure o cadastro que deseja e clique no botão com imagem de um 'lápis' do lado direito da listagem.<br /><img src="/projeto/gif/editarCliente2.gif" title="Editar" class="gif"></div>
