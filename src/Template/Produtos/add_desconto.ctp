...
<body style="text-align: center; margin-left: 16%;">
    <h2 class="page-header">Editar Descontos</h2>
    <p>
        <label class="control-label">Adicionar Desconto em Todos Produtos: </label>
        <input type="number" name="addDesconto" step="any" class="form-control addDesconto" id="addDesconto" style="width: 10%; margin-left: 45%;">
    </p>
    <?= $this->Form->create($produtos) ?>
    <form action="/projeto/produtos/desconto/" method="post">
        <table class="table table-striped"  cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th scope="col" style="text-align: center;"><?= $this->Paginator->sort('Desconto') ?></th>
                    <th scope="col" style="text-align: center;"><?= $this->Paginator->sort('Estoque') ?></th>
                    <th scope="col" style="text-align: center;"><?= $this->Paginator->sort('Preço') ?></th>
                ...
                ?> 
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="number" name="desconto[]" step="any" class="form-control outroDesc" style="width: 20%; margin-left: 40%;">
                        </td>
...
<div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="div-modal modal-dialog modal-lg">
        ...
        <!-- Modal Header -->
            ...
            <div id="manual2" style="text-align: center;"><br />Ao estar no módulo de desconto, procure o cadastro que deseja e clique no botão com imagem de um 'lápis' do lado direito da listagem.<br /><img src="/projeto/gif/editarDesconto2.gif" title="Editar" class="gif"></div>
...
$(document).ready(function () {    
    ...
    $("#addDesconto").on("input", function(){   
        var addDesconto = ($(this).val());
        console.log(addDesconto);
        $(".outroDesc").attr('value', addDesconto);
    });
</script>