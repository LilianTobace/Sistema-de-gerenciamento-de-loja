...
<head>
    <ul class="nav nav-sidebar bodyDiv">
...
<body class="panel panel-default body">
    <h1 class="page-header bodyDiv">Novo Cadastro de Produto</h1>
         ...
         <div class="divCodigo">
            ...
            ?>
                <div id="estoquista"  class="divDesconto">
                    ...
                    <?php echo '<input type="number" name="desconto2" id="desconto2" readonly="true" class="form-control desconto" value="00">'; ?>
                </div>
            <?php 
            }
            ?>
