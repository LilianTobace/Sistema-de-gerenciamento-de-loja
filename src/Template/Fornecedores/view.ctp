...
<body style="text-align: center;">
    ...
    <div class="panel panel-default" style=" margin-left: 16.7%;">
        <div class="panel-heading">
            <h3 class="panel-title"  style="text-align: center; text-indent: -10%; font-size: 200%;"><?= h($fornecedore->name) ?></h3>
        </div>
        ...
        <table class="table table-striped" style="text-align: center;">
           <tr>
            ...
            <tr>
                <td><?= __('Telefone') ?></td>
                <td><?= h($fornecedore->telefone2_forn) ?></td>
            </tr>
            <tr>
                <td><?= __('Endereço') ?></td>
                <td><?= h($fornecedore->endereco_forn) ?></td>
            </tr>
            <tr>
                <td><?= __('Nº') ?></td>
                <td><?= h($fornecedore->numero_forn) ?></td>
            </tr>
            <tr>
                <td><?= __('Bairro') ?></td>
                <td><?= h($fornecedore->bairro_forn) ?></td>
            </tr>
            <tr>
                <td><?= __('Cidade') ?></td>
            ...
            <tr>
                <td><?= __('Comentário') ?></td>
                <td><?= h($fornecedore->comentario_forn) ?></td>
            </tr>
 
            <tr>
                <td><?= __('CEP') ?></td>
                <td><?= $this->Number->format($fornecedore->cep_forn) ?></td>
            </tr>
            <tr>
                <td><?= __('Criado') ?></td>
...
<div class="modal fade bd-example-modal-xl" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
    <div class="div-modal modal-dialog modal-lg">
        ...
        <!-- Modal Header -->
            ...
            <div id="2" style="text-align: center;"><br />Ao estar no módulo de fornecedores, procure o cadastro que deseja e clique no botão com imagem de um 'lápis' do lado direito da listagem.<br /><img src="/projeto/gif/editarForn2.gif" title="Editar" class="gif"></div>
